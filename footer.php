...
<?php if ( $us_layout->footer_show_bottom ): ?>
	...
	<div class="l-subfooter at_bottom">
		<div class="l-subfooter-h i-cf">
			...
			<div class="w-copyright">Copyright &copy; <?php echo date('Y'); ?> <?php echo bloginfo('name'); ?> | <a href="http://insightfuldevelopment.com" target="blank">Website Development</a> | <a href="/privacy-policy/">Privacy Policy</a> | <a href="/terms-of-use/">Terms of Use</a></div>
